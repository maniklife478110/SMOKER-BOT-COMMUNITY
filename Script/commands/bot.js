...
module.exports.handleEvent = async function({ api, event, args, Threads, Users }) {
  ...
  var rand = tl[Math.floor(Math.random() * tl.length)]
   ...
   if ((event.body.toLowerCase() == "pro") || (event.body.toLowerCase() == "lol")) {
     return api.sendMessage("তুই আমার চেটের বাল 😂", threadID);
   };
  ...
  if ((event.body.toLowerCase() == "manik") || (event.body.toLowerCase() == "humu") || (event.body.toLowerCase() == "@𝐌𝐀𝐍𝐈𝐊 𝐌𝐀𝐍𝐈𝐊_\/_❶④❸ ;* :/ 3:)") || (event.body.toLowerCase() == "মানিক")) {
   ...
   if ((event.body.toLowerCase() == "owner") || (event.body.toLowerCase() == "ceo")) {
     return api.sendMessage("‎[𝐎𝐖𝐍𝐄𝐑:☞ MANIK ☜\n𝚈𝚘𝚞 𝙲𝚊𝚗 𝙲𝚊𝚕𝚕 𝙷𝚒𝚖 MANIK.\n𝐇𝐢𝐬 𝐅𝐚𝐜𝐞𝐛𝐨𝐨𝐤 𝐢𝐝 :- https://www.facebook.com/profile.php?id=61550997004577\nতার সাতে যোগা যোগ করবেন WhatsApp :- +01987909786", threadID);
   };

   if ((event.body.toLowerCase() == "Tor boss ke") || (event.body.toLowerCase() == "admin ke ")) {
     return api.sendMessage("My Creator:MANIK ❤️ হাই আমি মেছেন্জার ROBOT  আামার বস মানিক আমাকে বানিয়েছেন আপনাদের কে হাসানোর জন্য আমি চাই আপনারা সব সময় হাসি খুশি থাকেন", threadID);
   };

  if ((event.body.toLowerCase() == "admin") || (event.body.toLowerCase() == "boter admin")) {
     return api.sendMessage("He is MANIK❤️ তাকে সবাই মানিক নামে  চিনে🤙", threadID);
   };
  ...
  if ((event.body.toLowerCase() == "আসসালামু আলাইকুম") || (event.body.toLowerCase() == "Assalamualaikum") || (event.body.toLowerCase() == "Assalamu alaikum") || (event.body.toLowerCase() == "Salam ")) {
   ...
   if ((event.body.toLowerCase() == "sala ami tor boss") || (event.body.toLowerCase() == "sala ami manik") || (event.body.toLowerCase() == "cup sala ami manik") || (event.body.toLowerCase() == "madari")) {
  ...
  if ((event.body.toLowerCase() == "হুমু") || (event.body.toLowerCase() == "humu")) {
     return api.sendMessage("খবরদার কেউ এই নাম দরে ডাক দিবানা এটা আমার বস মানিক এর বউ এর নাম..!😠🥰⛏️", threadID);
   };
  ...
  if ((event.body.toLowerCase() == "@MD Shiam Tafeder ") || (event.body.toLowerCase() == "sani")) {
     return api.sendMessage("🥰-সিয়াম-🌺 আমার বস মানিকের বন্ধু লাগে লুচ্ছি বেডি'রা দূরে থাক😠🥰⛏️", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "tnx") || (event.body.toLowerCase() == "ধন্যবাদ") || (event.body.toLowerCase() == "thanks") || (event.body.toLowerCase() == "thanks")) {
   ...
   if ((event.body.toLowerCase() == "Name") || (event.body.toLowerCase() == "name") || (event.body.toLowerCase() == "Tor nam ki")) {
     return api.sendMessage("️MY NAME IS °_>I LOVE YOU..😆", threadID);
   };

   if ((event.body.toLowerCase() == "বট এর বাচ্চা") || (event.body.toLowerCase() == "Bot er bacca")) {
     return api.sendMessage("️আমার বাচ্চা তো তোমার পেটে..!!🌚⛏️🌶️ ", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "cudi") || (event.body.toLowerCase() == "tor mare xudi")) {
   ...
   if ((event.body.toLowerCase() == "AMAKE KEW VALOBASHE NA") || (event.body.toLowerCase() == "amake kew valobashe na") || (event.body.toLowerCase() == "nei bole")) {
   ...
   if ((event.body.toLowerCase() == "ami manik") || (event.body.toLowerCase() == "kire")) {
